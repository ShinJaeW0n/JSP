...
<body>
	<section id = "registForm"> 
		...
		<form action = "dogRegist.dog" method="post" name = "writeForm" enctype = "miltipart/form-data">
		...
		<tr>	
			<td colspan = "2" id = "commandCell">
				...
				<input type = "text" value  = "다시작성" />  
				<input type = "text" value = "개 상품 목록보기"  onClick = "window.location.href = 'dogList.dog'"/>  
			</td>
		</tr>
